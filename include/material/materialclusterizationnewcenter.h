...
#ifndef _MATERIALCLUSTERIZATIONNEWCENTER_H_
#define _MATERIALCLUSTERIZATIONNEWCENTER_H_
...
class MaterialClusterizationNewCenter: public Material
{
...
protected:
	...
	* @return nothing */
	MaterialClusterizationNewCenter(string &&name) : Material(move(name), move(string("MaterialClusterizationNewCenter")))
...
public:
	...
	* @return true if the shader was loaded successfully, and false otherwise */
	bool loadShader()
	{
		...
		void* shaderFirstPartCode  = InputOutput::readFile("../data/vulkanshaders/clusterizationnewcenterfirstpart.comp",  &sizeFirstPart);
		void* shaderSecondPartCode = InputOutput::readFile("../data/vulkanshaders/clusterizationnewcentersecondpart.comp", &sizeSecondPart);
		...
		m_shaderResourceName = "clusterizationnewcenter";
	...
	* @return nothing */
	void exposeResources()
	{
		...
		assignShaderStorageBuffer(move(string("clusterizationCenterPositivePreviousDirectionBuffer")), move(string("clusterizationCenterPositivePreviousDirectionBuffer")), VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
		assignShaderStorageBuffer(move(string("clusterizationCenterNegativePreviousDirectionBuffer")), move(string("clusterizationCenterNegativePreviousDirectionBuffer")), VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
		...
		assignShaderStorageBuffer(move(string("clusterizationNewCenterDebugBuffer")),                  move(string("clusterizationNewCenterDebugBuffer")),                  VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
...
#endif _MATERIALCLUSTERIZATIONNEWCENTER_H_
