...
#ifndef _MATERIALCLUSTERIZATIONPREPARE_H_
#define _MATERIALCLUSTERIZATIONPREPARE_H_
...
class MaterialClusterizationPrepare: public Material
{
...
protected:
	...
	* @return nothing */
	MaterialClusterizationPrepare(string &&name) : Material(move(name), move(string("MaterialClusterizationPrepare")))
...
public:
	...
	* @return true if the shader was loaded successfully, and false otherwise */
	bool loadShader()
	{
		...
		void* shaderFirstPartCode  = InputOutput::readFile("../data/vulkanshaders/clusterizationpreparefirstpart.comp",  &sizeFirstPart);
		void* shaderSecondPartCode = InputOutput::readFile("../data/vulkanshaders/clusterizationpreparesecondpart.comp", &sizeSecondPart);
		...
		m_shaderResourceName = "clusterizationprepare";
	...
	* @return nothing */
	void exposeResources()
	{
		...
		assignShaderStorageBuffer(move(string("clusterizationPrepareDebugBuffer")),   move(string("clusterizationPrepareDebugBuffer")),   VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
...
protected:
	...
	vec4   m_sceneMax;                   //!< Scene maximum aabb value
};

/////////////////////////////////////////////////////////////////////////////////////////////

#endif _MATERIALCLUSTERIZATIONPREPARE_H_
