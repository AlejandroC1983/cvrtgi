...
#ifndef _MATERIALCLUSTERIZATIONCOMPUTENEIGHBOUR_H_
#define _MATERIALCLUSTERIZATIONCOMPUTENEIGHBOUR_H_
...
class MaterialClusterizationComputeNeighbour : public Material
{
...
protected:
	...
	* @return nothing */
	MaterialClusterizationComputeNeighbour(string &&name) : Material(move(name), move(string("MaterialClusterizationComputeNeighbour")))
...
public:
	...
	* @return true if the shader was loaded successfully, and false otherwise */
	bool loadShader()
	{
		...
		void* shaderFirstPartCode  = InputOutput::readFile("../data/vulkanshaders/clusterizationcomputeneighbourfirstpart.comp", &sizeFirstPart);
		void* shaderSecondPartCode = InputOutput::readFile("../data/vulkanshaders/clusterizationcomputeneighboursecondpart.comp", &sizeSecondPart);
		...
		m_shaderResourceName = "clusterizationcomputeneighbour";
	...
	* @return nothing */
	void exposeResources()
	{
		...
		assignShaderStorageBuffer(move(string("clusterizationNeighbourDebugBuffer")), move(string("clusterizationNeighbourDebugBuffer")), VK_DESCRIPTOR_TYPE_STORAGE_BUFFER);
	}
...
#endif _MATERIALCLUSTERIZATIONCOMPUTENEIGHBOUR_H_
