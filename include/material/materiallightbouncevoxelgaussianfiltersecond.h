...
#ifndef _MATERIALLIGHTBOUNCEVOXELGAUSSIANFILTERSECOND_H_
#define _MATERIALLIGHTBOUNCEVOXELGAUSSIANFILTERSECOND_H_
...
class MaterialLightBounceVoxelGaussianFilterSecond: public Material
{
...
protected:
	...
	* @return nothing */
	MaterialLightBounceVoxelGaussianFilterSecond(string &&name) : Material(move(name), move(string("MaterialLightBounceVoxelGaussianFilterSecond")))
...
public:
	...
	* @return true if the shader was loaded successfully, and false otherwise */
	bool loadShader()
	{
		...
		void* shaderFirstPartCode  = InputOutput::readFile("../data/vulkanshaders/lightbouncevoxelgaussianfiltersecondfirstpart.comp", &sizeFirstPart);
		void* shaderSecondPartCode = InputOutput::readFile("../data/vulkanshaders/lightbouncevoxelgaussianfiltersecondsecondpart.comp", &sizeSecondPart);
...
#endif _MATERIALLIGHTBOUNCEVOXELGAUSSIANFILTERSECOND_H_
